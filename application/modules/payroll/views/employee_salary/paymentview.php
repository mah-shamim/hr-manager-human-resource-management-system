                        ...
                        <?php if (!empty($emp_pay)) { ?>
                            ...
                            <?php foreach ($emp_pay as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                        ...
                                        <td><?php echo $setting->currency_symbol.' '.$que->net_salary; ?></td>
                                        <td class="center">
                                   		
                                        <a target="_blank" href='<?php echo base_url("payroll/Payroll/salary_pay_slip/$que->id") ?>' class='btn btn-info btn-xs'>Payslip</a>
